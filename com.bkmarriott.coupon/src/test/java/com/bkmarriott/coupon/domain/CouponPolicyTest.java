...
class CouponPolicyTest {
    ...
    void calcExpireTime_successTest_forAfter() {
        ...
        CouponPolicy couponPolicy = new CouponPolicy(1L, CouponPolicyType.AFTER, afterDay, null, null);
        // When
        LocalDateTime actual = couponPolicy.calcExpireTime(baseTime);
        // Then
    ...
    void calcExpireTime_successTest_forFixed() {
        ...
        LocalDateTime baseTime = LocalDateTime.now();
        CouponPolicy couponPolicy = new CouponPolicy(1L, CouponPolicyType.FIXED, null, LocalDateTime.MIN, endedAt);
        // When
        LocalDateTime actual = couponPolicy.calcExpireTime(baseTime);
        // Then
        Assertions.assertAll(
    ...
    void calcExpireTime_successTest_forMixedWhenAfterDayIsSooner() {
        ...
        CouponPolicy couponPolicy = new CouponPolicy(1L, CouponPolicyType.MIXED, afterDay, LocalDateTime.MIN, endedAt);
        // When
        LocalDateTime actual = couponPolicy.calcExpireTime(baseTime);
        // Then
        Assertions.assertAll(
